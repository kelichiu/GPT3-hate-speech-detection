...
accuracy_racism <- rep(NA, 100)
accuracy_sexism <- rep(NA, 100)
accuracy_hate <- rep(NA, 100)
precision_racism <- rep(NA, 100)
precision_sexism <- rep(NA, 100)
precision_hate <- rep(NA, 100)
recall_racism <- rep(NA, 100)
recall_sexism <- rep(NA, 100)
recall_hate <- rep(NA, 100)
f1_racism <- rep(NA, 100)
f1_sexism <- rep(NA, 100)
f1_hate <- rep(NA, 100)
...
zero_racism_summary <- cbind(iter = 1:100,
                             accuracy_racism,
                             precision_racism,
                             recall_racism,
                             f1_racism) %>% 
...
zero_sexism_summary <- cbind(iter = 1:100,
                             accuracy_sexism,
                             precision_sexism,
                             recall_sexism,
                             f1_sexism) %>% 
...
zero_hate_summary <- cbind(iter = 1:100,
                             accuracy_hate,
                             precision_hate,
                             recall_hate,
                             f1_hate) %>% 
...
# Sample distributions of accuracy, precision, recall, and f1
one_racism_summary <- cbind(iter = 1:100,
                             accuracy_racism,
                             precision_racism,
                             recall_racism,
                             f1_racism) %>% 
...
one_sexism_summary <- cbind(iter = 1:100,
                             accuracy_sexism,
                             precision_sexism,
                             recall_sexism,
                             f1_sexism) %>% 
...
one_hate_summary <- cbind(iter = 1:100,
                             accuracy_hate,
                             precision_hate,
                             recall_hate,
                             f1_hate) %>% 
