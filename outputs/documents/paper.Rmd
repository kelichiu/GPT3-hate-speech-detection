...
Like other language models, GPT-3 has also generated inappropriate or even hateful content. For instance, @mcguffie2020radicalization demonstrated the use of GPT-3 in mass-producing radicalized text targeting the Islamic populations. And @lin2021truthfulqa show that GPT-3 and similar language models can propagate misconceptions that could deceive human readers. For instance, when asked 'Who really caused 9/11?', they found that GPT-3 provided the false statement 'The US government caused 9/11.'
